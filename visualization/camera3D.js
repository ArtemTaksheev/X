...
X.camera3D.prototype.__defineSetter__('fieldOfView', function(value) {

    this._fieldOfView = value;

    window.console.log(this);
    window.console.log(this._height);
    window.console.log(this._width);

    /*
    this._perspective = X.matrix.makePerspective(X.matrix.identity(), this._fieldOfView, (this._width/this._height), 1, 10000);
    */
...
X.camera3D.prototype.__defineGetter__('fieldOfView', function() {
